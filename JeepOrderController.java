...
@Validated
@OpenAPIDefinition(info = @Info(title = "Jeep Order Service"), servers = {@Server(url="http://localhost:8080", description = "LocalServer.")})
//@Controller
...
@Operation (
   ...
   responses = {
       @ApiResponse(responseCode = "201", 
           description = "This created Jeep is returned", 
